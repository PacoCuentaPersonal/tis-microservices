...
public class PageClientController {
    ...
    public String showClientPage(Model model) {
        ...
        model.addAttribute("client", new com.oauth2.app.oauth2_authorization_server.infrastructure.adapters.inbound.web.api.dto.request.clientOauth2.OAuth2ClientRegistrationRequest());
